...
function GridPagination({
  ...
  const ButtonArrow = ({ direction, disable = false, onPrev, onNext }: ButtonArrowProps) => {
  ...
  return (
    <div className="flex flex-row items-center justify-center w-full gap-3 xl:gap-1 ml-0 py-4">
      <div>
        <ButtonArrow 
          direction="back" 
          disable={disablePrev} 
      ...
      <div className="px-1 xl:px-2">
        <p 
          className="text-2xl font-normal xl:font-medium"
          style={{ color: '#666666' }}
        >
